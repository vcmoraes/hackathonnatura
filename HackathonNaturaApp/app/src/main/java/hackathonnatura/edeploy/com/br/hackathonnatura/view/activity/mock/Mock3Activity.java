 ...
 */
@EActivity(R.layout.activity_mock_3_activity)
public class Mock3Activity extends BaseActivity {
    ...
    @AfterViews
    public void init() {
        Bitmap banner = Util.loadBitmap(R.drawable.mock_3, getResources());
